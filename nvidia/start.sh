...
#         using harbor.baai.ac.cn/flagos-base/flagos-base-nvidia-cuda13.3 as base
...
#   ./nvidia/start.sh --rebuild               # force-rebuild dev image
...
#   ./nvidia/start.sh --base-tag 2.2.0        # use FlagOS base image version 2.2.0
#
